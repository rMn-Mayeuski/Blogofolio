...
const ContentPageActions:React.FC = () => {
    return (
        <div className={styles.actionsContainer}>
            <div className={styles.actionsContainerLeft}>
                <button type='button' className={styles.actionsContainerBTN}>
