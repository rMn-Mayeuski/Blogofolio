            ...
            <div className={styles.burgerMenuContent} onClick={e => e.stopPropagation()}>
                ...
                <div className={styles.burgerMenuContentBottom}>
                    <div className={styles.burgerMenuThemSwitch}>
                        <BurgerMenuBtnThemSwitch onClick={changeThemeLight}
                            ...
                            />
                        <BurgerMenuBtnThemSwitch onClick={changeThemeDark}
                            svg={ <svg width="24" height="24" viewBox="0 0 24 24" fill="red" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {!!user ?
                        <BurgerMenuBtn to='/signin' title='Log Out' onClick={handleLogOut}/> 
                            :
